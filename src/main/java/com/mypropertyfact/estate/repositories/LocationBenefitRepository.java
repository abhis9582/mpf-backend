...
public interface LocationBenefitRepository extends JpaRepository<LocationBenefit, Integer> {
    ...
    @Query("SELECT lb.id as id,lb.projectId, lb.distance as distance, lb.benefitName as benefitName, lb.iconImage as image, p.projectName as projectName FROM Project p " +
